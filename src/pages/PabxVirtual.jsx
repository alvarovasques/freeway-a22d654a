            ...
            <div className="bg-gray-900 text-white py-2 hidden md:block">
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-sm">
                    <div className="flex items-center gap-6">
                        <a href="https://wa.me/556733043003?text=Ol%C3%A1!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20PABX%20Virtual." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-400 transition-colors">
...
function RecursosSection() {
    ...
    return (
        <section id="recursos" className="py-14 bg-white">
...
function VantagensSection() {
    ...
    return (
        <section id="vantagens" className="py-14 bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto px-6">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
                    <Badge className="bg-orange-500/20 text-orange-300 border-orange-500/30 mb-6">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="lg:col-span-1">
                        <Card className="border-0 shadow-xl bg-white h-full">
                            <CardContent className="p-8 flex flex-col h-full">
                                ...
                                <a
                                    href={`https://wa.me/556733043003?text=${whatsappMsg}`}
                                    target="_blank"
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-3">
                            <a href="https://wa.me/556733043003?text=Ol%C3%A1!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20PABX%20Virtual." target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-orange-400 transition-colors">
