            ...
            <div className="bg-gray-900 text-white py-2 hidden md:block">
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-sm">
                    <div className="flex items-center gap-6">
                        <a href="https://wa.me/556730253131?text=Ol%C3%A1!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20Condom%C3%ADnios%20Inteligentes." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-orange-400 transition-colors">
    ...
    return (
        <section className="relative min-h-[50vh] flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0">
                <img 
                    src={condominiosHeroBg} 
                    alt="Condomínio inteligente com tecnologia de fibra óptica" 
                ...
                <div className="grid md:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="text-center">
                        <div className="space-y-2">
                            <a href="https://wa.me/556730253131?text=Ol%C3%A1!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20Condom%C3%ADnios%20Inteligentes." target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 text-gray-400 hover:text-orange-400 transition-colors">
